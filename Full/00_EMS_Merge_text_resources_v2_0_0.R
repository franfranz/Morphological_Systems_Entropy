...
# in this script, the morphologically annotated list Morph-It! (Zanchetta & Baroni, 2005)
...
# this is the subdirectory of wd_code where the df with all nouns is going to be output
